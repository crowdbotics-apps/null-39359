...
## Project Structure
    ...
    ├── success_staffing_ll_39359  # Django project configurations
...
1. Clone this repo and `cd success_staffing_ll_39359`
...
2. Clone this repo and `cd success_staffing_ll_39359`
